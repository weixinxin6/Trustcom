...
def get_argparse():
    ...
    parser.add_argument("--embed_path", default=None, type=str, required=True,
                        help="Path to word2vec embedding")
    ...
    parser.add_argument("--lstm_hidden_dim", default=100, type=int,
                        help="The dim of lstm hidden layer", )
    parser.add_argument("--lstm_layers", default=1, type=int,
                        help="The num of lstm layer", )
    parser.add_argument("--num_train_epochs", default=3.0, type=float,
                        help="Total number of training epochs to perform.")
    parser.add_argument('--markup', default='bios', type=str,
                        choices=['bios', 'bio', 'bioes'])
    parser.add_argument('--train_data_limit', default=-1, type=int,
                        help="Train data limitation for few-shot evaluation")
    ...
    # parser.add_argument("--language", default="ch", type=str, required=True,
    #                     help="The task language: ", choices=['ch', 'en'])
    ...
    #
    # parser.add_argument('--lstm_hidden_dim', default=100, type=int,
    #                     help="Hidden layer dim for lstm layer")
    # parser.add_argument('--lstm_layer_num', default=1, type=int,
    #                     help="Layer num of lstm")
